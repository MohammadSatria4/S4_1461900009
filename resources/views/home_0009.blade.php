...
<nav class="navbar navbar-dark bg-primary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">Praktikum4</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Praktikum4</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Praktikum4</a>
        </li>
        <li class="nav-item">
          <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Praktikum4</a>
        </li>
      </ul>
    </div>
  </div>
